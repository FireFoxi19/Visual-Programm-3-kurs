...
InputDialog_Gluzdov_Kopytina::InputDialog_Gluzdov_Kopytina(QWidget* pwgt): QDialog(pwgt)
{
...
QString InputDialog_Gluzdov_Kopytina::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Gluzdov_Kopytina::lastName() const
{
